...
print("coefficient of determination R^2 on train data {:.3}"
      .format(reg.score(feature_train, target_train)))
print("coefficient of determination R^2 on test data  {:.3}"
